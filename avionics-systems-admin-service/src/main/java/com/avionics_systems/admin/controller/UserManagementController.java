...
import com.avionics_systems.admin.service.UserManagementService;
...
public class UserManagementController {
    ...
    public ResponseEntity<GroupEntity> createGroup(
            ...
            @RequestParam(defaultValue = "AVIONICS_SYSTEMS_INTERNAL") String type) {
    ...
    @PutMapping("/project-roles/{roleId}")
    @Operation(summary = "Update a project role")
    public ResponseEntity<ProjectRoleEntity> updateProjectRole(
            @PathVariable String roleId,
            @RequestParam(required = false) String name,
            @RequestParam(required = false) String description) {
        return ResponseEntity.ok(userManagementService.updateProjectRole(roleId, name, description));
    }

    @DeleteMapping("/project-roles/{roleId}")
    @Operation(summary = "Delete a project role")
    public ResponseEntity<Void> deleteProjectRole(@PathVariable String roleId) {
        userManagementService.deleteProjectRole(roleId);
        return ResponseEntity.noContent().build();
    }
