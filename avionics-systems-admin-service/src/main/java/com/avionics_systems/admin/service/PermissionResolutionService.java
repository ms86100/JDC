 ...
 * Implements the full User→Group→Role→Permission chain for Avionics Systems DC compliance.
 */
@Service
...
public class PermissionResolutionService {
    ...
    @Value("${app.permissions.admin-group-id:grp-avionics-systems-administrators}")
    ...
    public boolean hasGlobalPermission(String userId, String permissionKey) {
        ...
        // For now, check if user is in avionics-systems-administrators group
