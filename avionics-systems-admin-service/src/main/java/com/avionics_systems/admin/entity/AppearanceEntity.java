...
public class AppearanceEntity {
    ...
    private String appName = "Avionics Systems Clone";

    @Column(name = "login_page_message")
    private String loginPageMessage = "Welcome to Avionics Systems Clone";

    @Column(name = "footer_message")
    private String footerMessage = "Powered by Avionics Systems Clone Platform";
