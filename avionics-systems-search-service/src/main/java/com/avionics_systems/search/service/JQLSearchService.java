...
import com.avionics_systems.search.dto.JQLSearchResponse.IssueSummary;
import com.avionics_systems.search.entity.*;
...
/**
 * JQL Search Service - Full JQL implementation matching Legacy DC
 * Now with real search execution via avionics-systems-issue-service integration
 */
@Service
...
public class JQLSearchService {
    ...
    @Value("${services.issue.url:http://avionics-systems-issue-service:8084}")
    private String issueServiceUrl;

    @Value("${services.project.url:http://avionics-systems-project-service:8083}")
