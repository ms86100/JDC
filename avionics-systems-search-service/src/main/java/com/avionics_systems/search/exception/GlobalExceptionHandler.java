package com.avionics_systems.search.exception;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleValidationException(MethodArgumentNotValidException ex) {
        ...
        ErrorResponse errorResponse = ErrorResponse.builder()
                ...
                .message(messageSource.getMessage("error.invalid-request-params", null, "Invalid request parameters", Locale.ENGLISH))
    ...
    public ResponseEntity<ErrorResponse> handleGenericException(Exception ex) {
        ...
        ErrorResponse errorResponse = ErrorResponse.builder()
                ...
                .error(messageSource.getMessage("error.internal-server-error", null, "Internal Server Error", Locale.ENGLISH))
