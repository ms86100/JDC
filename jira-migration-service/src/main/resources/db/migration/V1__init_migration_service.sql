...
-- Project Template
(uuid_generate_v4(), 'Project Import', 'PROJECT', '1.0',
'[
...
-- Issue Template
(uuid_generate_v4(), 'Issue Import', 'ISSUE', '1.0',
'[
...
-- User Template
(uuid_generate_v4(), 'User Import', 'USER', '1.0',
'[
...
(uuid_generate_v4(), 'project_key_required', 'PROJECT', 'project_key', 'REQUIRED',
'{}', 'Project key is required', 'ERROR', true, 1),
(uuid_generate_v4(), 'project_key_pattern', 'PROJECT', 'project_key', 'FORMAT',
...
(uuid_generate_v4(), 'project_key_unique', 'PROJECT', 'project_key', 'UNIQUE',
'{"table": "projects", "column": "project_key"}', 'Project key already exists', 'ERROR', true, 3),
(uuid_generate_v4(), 'project_name_required', 'PROJECT', 'name', 'REQUIRED',
'{}', 'Project name is required', 'ERROR', true, 4),

(uuid_generate_v4(), 'issue_project_required', 'ISSUE', 'project_key', 'REQUIRED',
'{}', 'Project key is required', 'ERROR', true, 10),
(uuid_generate_v4(), 'issue_type_required', 'ISSUE', 'issue_type', 'REQUIRED',
'{}', 'Issue type is required', 'ERROR', true, 11),
(uuid_generate_v4(), 'issue_summary_required', 'ISSUE', 'summary', 'REQUIRED',
'{}', 'Issue summary is required', 'ERROR', true, 12),
(uuid_generate_v4(), 'issue_summary_max_length', 'ISSUE', 'summary', 'RANGE',
'{"max": 500}', 'Summary cannot exceed 500 characters', 'ERROR', true, 13),
(uuid_generate_v4(), 'issue_status_required', 'ISSUE', 'status', 'REQUIRED',
'{}', 'Status is required', 'ERROR', true, 14),
(uuid_generate_v4(), 'issue_parent_fk', 'ISSUE', 'parent_key', 'FK',
'{"entity": "ISSUE", "field": "issue_key"}', 'Parent issue does not exist', 'ERROR', false, 15),

(uuid_generate_v4(), 'user_username_required', 'USER', 'username', 'REQUIRED',
'{}', 'Username is required', 'ERROR', true, 20),
(uuid_generate_v4(), 'user_email_required', 'USER', 'email', 'REQUIRED',
'{}', 'Email is required', 'ERROR', true, 21),
(uuid_generate_v4(), 'user_email_format', 'USER', 'email', 'FORMAT',
