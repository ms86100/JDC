...
import com.jira.migration.workflow.importing.WorkflowXmlImportService;
...
import com.jira.migration.service.clients.dto.CommentResponse;
import com.jira.migration.service.clients.dto.CreateIssueRequest;
import com.jira.migration.persister.IssuePersisterHandler.IssuePersisterResult;
...
public class ProjectImportOrchestrator {
        ...
        try {
            return switch (entityType) {
                ...
                case "ATTACHMENT" -> ImportEntityResult.skipped(
                        "Import ATTACHMENT via Jira DC XML or CSV attachment columns");
    ...
    private ImportEntityResult importWorklogs(UUID jobId, UUID sourceId, UUID targetId) {
        return ImportEntityResult.ok(0, "Worklogs imported via Jira DC XML path for project " + targetId);
    }
