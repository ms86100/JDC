...
public class JiraDcImportApiService {

    private final JiraDcImportOrchestrator orchestrator;
    ...
    public Map<String, Object> validateUpload(
        ...
        JiraDcImportOrchestrator.ResolvedInputs resolved = orchestrator.resolveInputs(
                xmlOrZipPath, optionalAttachmentBundleZip, uploadedAsBackupZip);

        try {
            JiraDcImportOrchestrator.PrepareResult prep = orchestrator.prepareValidate(
                    resolved.xmlPath(),
    ...
    private static String buildValidateMessage(JiraDcImportOrchestrator.PrepareResult prep) {
    ...
    private static List<Map<String, Object>> buildConflicts(JiraDcImportOrchestrator.PrepareResult prep) {
    ...
    private static List<Map<String, Object>> extractUnknownFields(JiraDcImportOrchestrator.PrepareResult prep) {
    ...
    private void cleanup(JiraDcImportOrchestrator.ResolvedInputs resolved) {
