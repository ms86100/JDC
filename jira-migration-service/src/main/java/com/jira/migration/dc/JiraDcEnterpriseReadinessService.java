...
public class JiraDcEnterpriseReadinessService {
    ...
    public Map<String, Object> getAcSignoff(UUID jobId) {
        ...
        return JiraDcAcSignoffEvaluator.evaluate(
                meta,
                parseOptions(job),
    ...
    public Map<String, Object> buildSlaProofFromJob(MigrationJob job) {
        ...
        return JiraDcImportSlaProofBuilder.build(issueCount, durationMs, failed, stub, "LIVE_IMPORT_JOB");
    }
