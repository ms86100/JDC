 ...
 */
public final class JiraDcConflictResolutionApplier {

    private JiraDcConflictResolutionApplier() {
    }

    @SuppressWarnings("unchecked")
    public static List<JiraDcXmlParser.ParsedEntity> applySkipEntities(
    ...
    @SuppressWarnings("unchecked")
    public static void applyFieldOverrides(List<JiraDcXmlParser.ParsedEntity> entities, Map<String, Object> options) {
