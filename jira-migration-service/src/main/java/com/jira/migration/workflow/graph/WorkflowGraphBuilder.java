package com.jira.migration.workflow.graph;
...
public class WorkflowGraphBuilder {
    ...
    public WorkflowGraph build(WorkflowDescriptorModel descriptor) {
        ...
        for (WorkflowStepModel step : descriptor.getSteps()) {
            String statusName = step.getMeta().getOrDefault("jira.status.name", step.getName());
            String statusId = step.getMeta().getOrDefault("jira.status.id", step.getId());
