...
import com.jira.migration.service.field.*;
...
public class FieldController {
    ...
    public ResponseEntity<List<Map<String, Object>>> getCustomFieldOptions(@PathVariable UUID id) {
        List<com.jira.migration.entity.field.CustomFieldOption> options =
    ...
    @Operation(summary = "Initialize built-in fields", description = "Initializes all built-in Jira field definitions")
    @PreAuthorize("hasRole('ADMIN')")
