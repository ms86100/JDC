...
call :run_migration "plan_db" "%PROJECT_ROOT%jira-plan-service\src\main\resources\db\migration\V14__create_plan_issue_sources.sql" "V14__create_plan_issue_sources.sql" "%DB_USER_JIRA%"
call :run_migration "plan_db" "%PROJECT_ROOT%jira-plan-service\src\main\resources\db\migration\V15__create_exclusion_rules.sql" "V15__create_exclusion_rules.sql" "%DB_USER_JIRA%"
call :run_migration "plan_db" "%PROJECT_ROOT%jira-plan-service\src\main\resources\db\migration\V16__create_plan_permissions.sql" "V16__create_plan_permissions.sql" "%DB_USER_JIRA%"
call :run_migration "plan_db" "%PROJECT_ROOT%jira-plan-service\src\main\resources\db\migration\V17__add_missing_indexes.sql" "V17__add_missing_indexes.sql" "%DB_USER_JIRA%"
call :run_migration "plan_db" "%PROJECT_ROOT%jira-plan-service\src\main\resources\db\migration\V18__add_extra_indexes.sql" "V18__add_extra_indexes.sql" "%DB_USER_JIRA%"
call :run_migration "plan_db" "%PROJECT_ROOT%jira-plan-service\src\main\resources\db\migration\V19__add_wip_limit_to_sprints.sql" "V19__add_wip_limit_to_sprints.sql" "%DB_USER_JIRA%"
call :run_migration "plan_db" "%PROJECT_ROOT%jira-plan-service\src\main\resources\db\migration\V20__add_board_config_audit_log.sql" "V20__add_board_config_audit_log.sql" "%DB_USER_JIRA%"
call :run_migration "plan_db" "%PROJECT_ROOT%jira-plan-service\src\main\resources\db\migration\V21__add_is_active_to_plan_releases.sql" "V21__add_is_active_to_plan_releases.sql" "%DB_USER_JIRA%"
call :run_migration "plan_db" "%PROJECT_ROOT%jira-plan-service\src\main\resources\db\migration\V22__add_is_active_to_plan_items.sql" "V22__add_is_active_to_plan_items.sql" "%DB_USER_JIRA%"
call :run_migration "plan_db" "%PROJECT_ROOT%jira-plan-service\src\main\resources\db\migration\V23__add_optimistic_locking_version.sql" "V23__add_optimistic_locking_version.sql" "%DB_USER_JIRA%"
call :run_migration "plan_db" "%PROJECT_ROOT%jira-plan-service\src\main\resources\db\migration\V24__add_target_end_date_to_plan_items.sql" "V24__add_target_end_date_to_plan_items.sql" "%DB_USER_JIRA%"
call :run_migration "jira_platform" "%PROJECT_ROOT%jira-plan-service\src\main\resources\db\migration\V14__create_plan_issue_sources.sql" "V14__create_plan_issue_sources.sql (jira_platform)" "%DB_USER_JIRA%"
call :run_migration "jira_platform" "%PROJECT_ROOT%jira-plan-service\src\main\resources\db\migration\V15__create_exclusion_rules.sql" "V15__create_exclusion_rules.sql (jira_platform)" "%DB_USER_JIRA%"
call :run_migration "jira_platform" "%PROJECT_ROOT%jira-plan-service\src\main\resources\db\migration\V16__create_plan_permissions.sql" "V16__create_plan_permissions.sql (jira_platform)" "%DB_USER_JIRA%"
call :run_migration "jira_platform" "%PROJECT_ROOT%jira-plan-service\src\main\resources\db\migration\V17__add_missing_indexes.sql" "V17__add_missing_indexes.sql (jira_platform)" "%DB_USER_JIRA%"
call :run_migration "jira_platform" "%PROJECT_ROOT%jira-plan-service\src\main\resources\db\migration\V18__add_extra_indexes.sql" "V18__add_extra_indexes.sql (jira_platform)" "%DB_USER_JIRA%"
call :run_migration "jira_platform" "%PROJECT_ROOT%jira-plan-service\src\main\resources\db\migration\V19__add_wip_limit_to_sprints.sql" "V19__add_wip_limit_to_sprints.sql (jira_platform)" "%DB_USER_JIRA%"
call :run_migration "jira_platform" "%PROJECT_ROOT%jira-plan-service\src\main\resources\db\migration\V20__add_board_config_audit_log.sql" "V20__add_board_config_audit_log.sql (jira_platform)" "%DB_USER_JIRA%"
call :run_migration "jira_platform" "%PROJECT_ROOT%jira-plan-service\src\main\resources\db\migration\V21__add_is_active_to_plan_releases.sql" "V21__add_is_active_to_plan_releases.sql (jira_platform)" "%DB_USER_JIRA%"
call :run_migration "jira_platform" "%PROJECT_ROOT%jira-plan-service\src\main\resources\db\migration\V22__add_is_active_to_plan_items.sql" "V22__add_is_active_to_plan_items.sql (jira_platform)" "%DB_USER_JIRA%"
call :run_migration "jira_platform" "%PROJECT_ROOT%jira-plan-service\src\main\resources\db\migration\V23__add_optimistic_locking_version.sql" "V23__add_optimistic_locking_version.sql (jira_platform)" "%DB_USER_JIRA%"
call :run_migration "jira_platform" "%PROJECT_ROOT%jira-plan-service\src\main\resources\db\migration\V24__add_target_end_date_to_plan_items.sql" "V24__add_target_end_date_to_plan_items.sql (jira_platform)" "%DB_USER_JIRA%"
echo.
