package com.avionics_systems.user.service;

import com.avionics_systems.user.dto.*;
import com.avionics_systems.user.entity.*;
import com.avionics_systems.user.exception.DuplicateResourceException;
import com.avionics_systems.user.exception.ResourceNotFoundException;
import com.avionics_systems.user.repository.*;
...
@Slf4j
public class AvionicsSystemUserManagementService {
    ...
    private UserResponse mapToUserResponse(CwdUser user) {
        ...
        List<UserResponse.GroupInfo> groupInfos = groups.stream()
                .map(g -> UserResponse.GroupInfo.builder()
                        ...
                        .isAvionicsSystemSoftware(g.getGroupName().contains(softwareGroupKeyword))
                        .build())
                .collect(Collectors.toList());
