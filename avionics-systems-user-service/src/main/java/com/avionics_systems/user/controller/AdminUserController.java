...
import com.avionics_systems.user.service.AvionicsSystemUserManagementService;
...
public class AdminUserController {
    ...
    private final AvionicsSystemUserManagementService userService;
    ...
    public ResponseEntity<GroupResponse> updateGroup(
        ...
        GroupResponse group = userService.updateGroup(groupId, request);
