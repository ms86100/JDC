...
import com.avionics_systems.project.service.TemplateService;
...
public class TemplateController {
    ...
    @Operation(summary = "Get template catalog",
            description = "Returns Legacy DC-style template catalog with categories, capabilities, and recommended templates")
