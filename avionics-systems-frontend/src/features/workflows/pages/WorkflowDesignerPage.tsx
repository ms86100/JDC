...
const edgeMarker = { type: MarkerType.ArrowClosed, color: 'var(--sa-brand-500)' };
const edgeStyle = { stroke: 'var(--sa-brand-500)', strokeWidth: 2 };
const edgeLabelStyle = { fontSize: 11, fill: 'var(--sa-n700)' };
      ...
      <div className="wf-designer-canvas wf-designer-reactflow">
        {layoutLoading && !hasDiagram && !layoutError ? (
          ...
          >
            ...
            <Background gap={16} size={1} color="var(--sa-n200)" />
            <Controls />
            <MiniMap />
          </ReactFlow>
          </>
