    ...
    <div className="space-y-6" data-testid="workflow-admin-hub">
      <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
        {SECTIONS.map((s) => (
          <Link
            key={s.path}
            to={s.path}
            className="block p-4 bg-white border rounded-lg hover:border-avisys-blue hover:shadow-sm transition"
          >
      ...
      <div className="bg-white border rounded-lg p-4">
        ...
        <div className="flex flex-wrap gap-2">
          <Link to="/workflows/open?view=detail" className="text-sm text-avisys-blue underline">
            Open configuration…
          </Link>
          <span className="text-gray-300">|</span>
          <Link to="/workflows/open?view=designer" className="text-sm text-avisys-blue underline">
            Open designer…
          </Link>
          <span className="text-gray-300">|</span>
          <Link to="/workflows" className="text-sm text-avisys-blue underline">
            Workflow hub
          </Link>
        </div>
      </div>
