...
import { useCreateAviSysUser } from '../hooks/useAdminApi';
import './AviSysCreateUser.css';

export default function AviSysCreateUser() {
  const navigate = useNavigate();
  const createUser = useCreateAviSysUser();
