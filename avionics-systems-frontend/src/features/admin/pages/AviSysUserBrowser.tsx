...
import { useAviSysUsers, useAviSysGroups } from '../hooks/useAdminApi';
import type { AviSysUser } from '../hooks/useAdminApi';
import { appNotify } from '../../../lib/appNotify';
import './AviSysUserBrowser.css';

export default function AviSysUserBrowser() {
  ...
  const { data, isLoading, refetch } = useAviSysUsers({
          ...
          <div className="filter-row">
            ...
            <div className="filter-field">
              ...
              >
                ...
                <option value="avisys-software">Systems and Avionics</option>
              </select>
            </div>
            <div className="filter-field">
...
function UserRow({ user }: { user: AviSysUser }) {
  return (
