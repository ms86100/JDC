...
import { useAviSysGroupByName } from '../hooks/useAdminApi';
import './AviSysViewGroup.css';

export default function AviSysViewGroup() {
  const [searchParams] = useSearchParams();
  const groupName = searchParams.get('name') || '';

  const { data: group, isLoading, error } = useAviSysGroupByName(groupName);
