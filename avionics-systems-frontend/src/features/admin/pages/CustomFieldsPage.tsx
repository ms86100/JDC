      ...
      <div className="admin-page">
        <div className="admin-page-header">
          ...
          <p className="admin-page-description">
            Create and manage custom fields (Systems DC parity — backed by migration field registry).
          </p>
        </div>
        ...
        <div className="custom-fields-where-callout" data-testid="custom-fields-where-callout">
          ...
          <p className="custom-fields-where-note">
            ...
            are Systems Advanced Roadmaps / planning fields — they store link and date planning data on
