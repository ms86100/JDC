...
import MigrationServiceHealthPanel from '../../migration/components/MigrationServiceHealthPanel';
...
export default function DataCenterPage() {
  ...
  const renderServicesSection = () => (
    <div className="services-section">
      <div className="section-header">
        <h3 className="section-title">Downstream Microservices</h3>
        <p className="section-description">Live health status of all platform microservices.</p>
      </div>

      <MigrationServiceHealthPanel />

      <div className="section-header" style={{ marginTop: 24 }}>
        <h3 className="section-title">System Services</h3>
        <p className="section-description">Monitor and manage internal system services.</p>
      </div>
