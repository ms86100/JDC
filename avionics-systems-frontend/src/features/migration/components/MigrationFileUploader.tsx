...
export default function MigrationFileUploader({
  ...
  importTypeLabel = 'CSV, Excel (.xlsx), or Systems DC XML',
        ...
        <div className="bg-white rounded-lg border p-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
            {templates.map((template) => (
              <div
                key={template.id}
                className="bg-gray-50 rounded-lg p-3 border border-gray-200 hover:border-avisys-blue transition-colors"
              >
        ...
        {showProgress ? (
          <div className="flex flex-col items-center w-full max-w-md mx-auto">
            ...
            <div className="w-full h-2 bg-gray-200 rounded-full overflow-hidden">
              <div
                className="h-full bg-avisys-blue transition-all duration-200"
