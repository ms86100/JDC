...
const JOB_TYPE_LABELS: Record<string, string> = {
  CSV: 'CSV Import',
  ISSUE_XML: 'Issue XML (Systems DC)',
  LEGACY_DC: 'Systems and Avionics Import',
...
export default function JobHistoryTable({
  ...
  const SortIcon = ({ field }: { field: 'initiatedAt' | 'jobType' | 'status' }) => {
    ...
    return <span className="text-avisys-blue ml-1">{sortDirection === 'asc' ? '↑' : '↓'}</span>;
  };
    ...
    return (
      ...
      >
        ...
        <p style={{ margin: '8px 0 0', fontSize: 'var(--sa-fs-sm)', color: 'var(--sa-n700)' }}>
          Ensure avionics-systems-migration-service is running on port 8094.
        </p>
      </div>
    );
  }
      ...
      <div className="px-4 py-3 border-b bg-gray-50 flex flex-wrap items-center gap-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <select
            ...
            className="px-2 py-1 text-sm border border-gray-300 rounded focus:outline-none focus:ring-1 focus:ring-avisys-blue"
          >
        ...
        <div className="flex items-center gap-2">
          ...
          >
            ...
            <option value="ISSUE_XML">Issue XML (Systems DC)</option>
            <option value="LEGACY_DC">Systems and Avionics Import</option>
                    ...
                    <div className="flex items-center justify-end gap-2">
                      {onViewDetails && (
                        <button
                          ...
                          className="text-avisys-blue hover:text-blue-700"
                          title="View Details"
                        >
                          View
                        </button>
              ...
              return (
                <button
                  ...
                  className={`px-3 py-1 text-sm border rounded ${
                    page === pageNum
                      ? 'bg-avisys-blue text-white border-avisys-blue'
