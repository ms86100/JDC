    ...
    <div className="space-y-6" data-testid="migration-import-settings-panel">
      <div>
        ...
        <p className="text-sm text-gray-600 mt-1">
          Avionics Systems parity: attachment limits, FILE: directory, API guidance (G-05, G-07, G-08).
        </p>
      </div>
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <div className="bg-white border rounded-lg p-4">
          ...
          <Link to="/admin/system/attachments" className="text-sm text-avisys-blue underline mt-2 inline-block">
