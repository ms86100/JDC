  ...
  return (
    <div className="rounded-lg border border-gray-200 bg-gray-50 px-4 py-3 text-sm">
      ...
      <ul className="space-y-1 text-xs">
        {data.healthUrl && (
          <li>
            <a href={data.healthUrl} target="_blank" rel="noreferrer" className="text-avisys-blue underline">
              Actuator health
            </a>
          </li>
        )}
        {data.prometheusUrl && (
          <li>
            <a href={data.prometheusUrl} target="_blank" rel="noreferrer" className="text-avisys-blue underline">
              Prometheus metrics
            </a>
          </li>
        )}
        {data.metricsUrl && (
          <li>
            <a href={data.metricsUrl} target="_blank" rel="noreferrer" className="text-avisys-blue underline">
              Micrometer metrics
            </a>
          </li>
        )}
