...
const IMPORT_TYPES = [
  ...
  },
  {
    ...
    description: 'Import Systems Data Center workflow-descriptor XML with validators, conditions, post-functions, and scheme binding.',
    icon: '⚙',
  ...
  },
  {
    ...
    title: 'Issue XML (Systems DC)',
    description:
      'Import Systems Data Center issue export XML (RSS/channel). Issues, comments, worklogs, links, custom fields, and optional attachment bundle.',
    icon: '📋',
    iconBg: 'bg-teal-100',
  ...
  {
    type: 'jira-dc-api' as const,
    title: 'Systems DC API Import',
    description: 'Import issues directly from a Systems Data Center instance using REST API with Personal Access Token (PAT).',
    icon: '🔗',
    iconBg: 'bg-cyan-100',
            ...
            >
              {isSelected && (
                <div className="absolute top-3 right-3">
                  <span className="text-avisys-blue text-xl">✓</span>
                </div>
              )}
              ...
              <div className="mt-4 pt-4 border-t border-gray-100">
                <ul className="space-y-1.5">
                  ...
                  {importType.type === 'jira-dc-api' && (
                    <>
                      <li className="flex items-center text-xs text-gray-600">
                        <span className="text-cyan-500 mr-2">✓</span>
                        Live connection via REST API + PAT
                      </li>
                      <li className="flex items-center text-xs text-gray-600">
                        <span className="text-cyan-500 mr-2">✓</span>
                        Issues, comments, attachments, worklogs
                      </li>
                      <li className="flex items-center text-xs text-gray-600">
                        <span className="text-cyan-500 mr-2">✓</span>
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 flex items-start gap-3">
        ...
        <div>
          ...
          <p className="text-blue-600 text-xs mt-1">
            <strong>Issue XML (Systems DC):</strong> Single issue export XML from Systems DC (RSS/channel format).
            ...
            <strong> Systems DC API:</strong> Live data-driven import from Systems Data Center using PAT authentication.
          </p>
        </div>
      </div>
    </div>
