...
export interface MigrationJob {
  id: string;
  jobType: 'CSV' | 'LEGACY_DC' | 'PROJECT_IMPORT' | 'PROJECT_EXPORT';
...
export interface ImportOptions {
  ...
  /** Avionics Systems: LIGHTWEIGHT vs External System Import (G-03) */
...
export interface JiraDcApiConfig {
  jiraBaseUrl: string;
  pat: string;
  projectKeys: string[];
  jqlFilter?: string;
...
export interface JiraDcConnectionTestResult {
  connected: boolean;
  jiraVersion?: string;
  userName?: string;
  projectCount?: number;
