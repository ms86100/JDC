...
export interface LegacyDcValidateResponse {
  valid: boolean;
  format?: string;
  totalEntities?: number;
...
export const migrationApi = {
  ...
  validateLegacyDcImport: (params: {
    ...
    return apiClient.post<LegacyDcValidateResponse>('/api/migration/import/legacy-dc/validate', formData, {
      headers: { 'Content-Type': 'multipart/form-data', ...migrationUserHeaders() },
    });
  },

  startLegacyDcImport: (params: {
    file: File;
    targetProjectId?: string;
    attachmentBundle?: File | null;
    backupZip?: boolean;
    ...
    return apiClient.post<MigrationJobResponse>('/api/migration/import/legacy-dc', formData, {
      headers: {
        'Content-Type': 'multipart/form-data',
  ...
  startJiraDcApiImport: (params: {
    ...
    apiClient.post<MigrationJobResponse>('/api/migration/import/jira-dc-api', params, {
      headers: {
