...
export const resolutionApi = {
  getAll: () => apiClient.get<Resolution[]>('/api/admin/master-data/resolutions'),
  create: (data: Partial<Resolution>) => apiClient.post<Resolution>('/api/admin/master-data/resolutions', data),
  update: (id: string, data: Partial<Resolution>) => apiClient.put<Resolution>(`/api/admin/master-data/resolutions/${id}`, data),
  delete: (id: string) => apiClient.delete(`/api/admin/master-data/resolutions/${id}`),
};
