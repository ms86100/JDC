 ...
 *
 * Replaces three previous shells (AppLayout, AviSysAdminLayout, AviSysGlobalLayout)
 ...
 * defined in src/styles/tokens.css. No reliance on avisys-classic.css here.
 *
...
import { AVISYS_DC_PRIMARY_TOP_NAV } from './avisysDcNavRegistry';
...
/** Avionics Systems primary bar + Plans + More (Tests/Migration/etc. stay discoverable). */
const TOP_NAV: { label: string; path: string; isPlans?: boolean; isMore?: boolean }[] = [
  ...AVISYS_DC_PRIMARY_TOP_NAV.map((i) => ({ label: i.label, path: i.path })),
