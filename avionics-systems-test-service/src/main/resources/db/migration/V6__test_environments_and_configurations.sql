...
-- ============================================
CREATE TABLE IF NOT EXISTS jira_test.test_environments (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    environment_name VARCHAR(100) NOT NULL UNIQUE,
    environment_type VARCHAR(50) DEFAULT 'TEST',
...
-- ============================================
CREATE TABLE IF NOT EXISTS jira_test.environment_configs (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
...
-- ============================================
CREATE TABLE IF NOT EXISTS jira_test.test_environment_assignments (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
...
-- ============================================
CREATE TABLE IF NOT EXISTS jira_test.browser_configs (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
...
-- ============================================
CREATE TABLE IF NOT EXISTS jira_test.device_configs (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
...
-- ============================================
CREATE TABLE IF NOT EXISTS jira_test.execution_matrices (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
...
-- INDEXES
-- ============================================
CREATE INDEX IF NOT EXISTS idx_test_environments_active ON jira_test.test_environments(is_active);
CREATE INDEX IF NOT EXISTS idx_environment_configs_env ON jira_test.environment_configs(environment_id);
CREATE INDEX IF NOT EXISTS idx_test_environment_assignments_test ON jira_test.test_environment_assignments(test_id);
CREATE INDEX IF NOT EXISTS idx_browser_configs_default ON jira_test.browser_configs(is_default);
CREATE INDEX IF NOT EXISTS idx_device_configs_default ON jira_test.device_configs(is_default);
