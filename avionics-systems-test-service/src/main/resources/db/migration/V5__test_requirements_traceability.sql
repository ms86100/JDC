...
-- ============================================
CREATE TABLE IF NOT EXISTS jira_test.requirements (
...
-- ============================================
CREATE TABLE IF NOT EXISTS jira_test.requirement_versions (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
...
-- ============================================
CREATE TABLE IF NOT EXISTS jira_test.test_requirement_coverage (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
...
-- ============================================
CREATE TABLE IF NOT EXISTS jira_test.test_coverage_metrics (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    project_id UUID NOT NULL,
...
-- ============================================
CREATE TABLE IF NOT EXISTS jira_test.requirement_change_log (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
...
-- INDEXES
-- ============================================
CREATE INDEX IF NOT EXISTS idx_requirements_key ON jira_test.requirements(requirement_key);
CREATE INDEX IF NOT EXISTS idx_requirements_project ON jira_test.requirements(project_id);
CREATE INDEX IF NOT EXISTS idx_coverage_test ON jira_test.test_requirement_coverage(test_id);
CREATE INDEX IF NOT EXISTS idx_coverage_requirement ON jira_test.test_requirement_coverage(requirement_id);
CREATE INDEX IF NOT EXISTS idx_coverage_metrics_project ON jira_test.test_coverage_metrics(project_id);
