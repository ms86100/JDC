package com.avionics_systems.test.plugin.controller;
...
import com.avionics_systems.test.plugin.listener.PluginLifecycleListener;
import com.avionics_systems.test.plugin.listener.PluginLifecycleListener.PluginStatusReport;
...
import com.avionics_systems.test.plugin.validation.PluginValidator;
import com.avionics_systems.test.plugin.validation.PluginValidator.CompleteValidationResult;
...
public class PluginController {
    ...
    public ResponseEntity<MarketplaceResponse> getAvailablePlugins() {
        ...
        available.add(new MarketplacePlugin(
                "avionics-systems-test-notifier",
                "Slack Notifier",
                "2.0.0",
        ...
        available.add(new MarketplacePlugin(
                "avionics-systems-test-automation",
                "CI/CD Integration",
                "1.5.0",
        ...
        available.add(new MarketplacePlugin(
                "avionics-systems-test-analytics",
    ...
    private Map<String, MarketplacePlugin> getMarketplaceMap() {
        ...
        map.put("avionics-systems-test-reporter", new MarketplacePlugin(
                "avionics-systems-test-reporter", "Advanced Test Reporter", "1.2.0",
                "Generates comprehensive test execution reports",
                "Avionics Systems Team", "Avionics Systems", List.of("READ_TESTS"), true));
        map.put("avionics-systems-test-notifier", new MarketplacePlugin(
                "avionics-systems-test-notifier", "Slack Notifier", "2.0.0",
    ...
    private PluginManifest createDefaultManifest(String pluginId, String filename, String projectId) {
        ...
        manifest.setEntryPoint("com.avionics_systems.test.plugin.DefaultPlugin");
        manifest.setProjectId(projectId);
