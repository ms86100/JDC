...
public class SeedDataInitializer implements CommandLineRunner {
    ...
    private void initializeSystemSettings() {
        ...
        settingsRepository.save(SystemSettingsEntity.builder()
                .settingKey("application.title").settingValue("Jira Platform").description("Application title").category("general").dataType("string").isSensitive(false).isSystem(true).build());
        settingsRepository.save(SystemSettingsEntity.builder()
    ...
    private void initializeLicense() {
        ...
        LicenseEntity license = LicenseEntity.builder()
                ...
                .licenseKey("EVL-JIRA-2026-XXXX-XXXX-XXXX")
