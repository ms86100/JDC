package com.jira.test.plugin.sandbox;
 ...
 * Provides isolation, timeout enforcement, and resource limits for plugin operations.
 */
public class PluginSandbox {
    ...
    private void initializeAllowedApis() {
        ...
        allowedApis.add("com.jira.test.plugin.hook.PluginHook");
        allowedApis.add("com.jira.test.plugin.hook.PluginHook$HookContext");
        allowedApis.add("com.jira.test.plugin.hook.PluginHook$HookResult");
        allowedApis.add("com.jira.test.plugin.hook.PluginHook$HookType");
    }
