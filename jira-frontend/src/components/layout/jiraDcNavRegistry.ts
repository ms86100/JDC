/**
 * Jira Data Center navigation registry (SSOT).
 * UX hierarchy matches Jira DC; styling remains Airbus via AppShell tokens.
 *
...
export const JIRA_DC_PRIMARY_TOP_NAV = [
...
/** Secondary top nav — Jira DC has no Tests/Migration in primary bar; kept discoverable here. */
 ...
 * Order mirrors Jira Software project nav from DC walkthrough frames.
 */
...
/** Jira DC Administration left-nav order (Issues-first). */
export const JIRA_DC_ADMIN_CATEGORY_ORDER = [
  'issues',
  'workflows',
  'fields',
  'projects',
