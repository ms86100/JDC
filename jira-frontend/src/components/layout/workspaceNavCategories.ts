...
export const WORKSPACE_NAV_CATEGORIES: WorkspaceNavCategory[] = [
...

  {
    ...
    items: [
      ...
      { label: 'Workflows (administration)', path: '/admin/workflows', description: 'Jira DC Issues → Workflows' },
...
export const WORKSPACE_NAV_OPERATIONS: WorkspaceNavCategory[] = [
...

  {
    ...
    items: [
      ...
      { label: 'Jira DC backup import', path: migrationPath('wizard', 'jira-dc'), description: 'Systems backup XML' },
