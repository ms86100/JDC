  ...
  return (
    <section>
      ...
      <p className="jdc-muted">
        Application links connect this Jira instance to other applications (Confluence, Bitbucket, etc.).
      </p>
      {isLoading ? (
        ...
        <div className="jdc-card jdc-empty-state-card" style={{ padding: 32, textAlign: 'center', marginTop: 16 }}>
          ...
          <p className="jdc-muted">
            Link Jira to other Atlassian products or external tools so issues, pages, and builds stay connected.
          </p>
