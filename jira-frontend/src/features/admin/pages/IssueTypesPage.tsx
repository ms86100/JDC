...
const ISSUE_TYPE_ICONS: Record<string, { icon: string; color: string }> = {
  ...
  task: { icon: '✅', color: 'var(--sa-brand-500)' },
...
export default function IssueTypesPage() {
  ...
  const getIssueTypeStyle = (issueType: IssueType) => {
    ...
    return { icon: issueType.name.charAt(0).toUpperCase(), color: 'var(--sa-brand-500)' };
  };
      ...
      <div className="it-header">
        <div className="it-header-content">
          ...
          <p className="it-subtitle">
            ...
            <Link to="/admin/issue-type-schemes" style={{ color: 'var(--sa-brand-500)', fontWeight: 500 }}>
              Issue type schemes
            </Link>
            .
          </p>
                  ...
                  <tr key={issueType.id}>
                    <td>
                      <div style={{ display: 'flex', gap: 12, alignItems: 'flex-start' }}>
                        ...
                        <div className="ab-it-name-cell">
                          ...
                          <code style={{ fontSize: 11, color: 'var(--sa-n600)' }}>{issueType.issueTypeKey}</code>
                    ...
                    <td>
                      {related.length > 0 ? (
                        ...
                        <span style={{ fontSize: 13, color: 'var(--sa-n500)' }}>No associated schemes</span>
                      )}
                    </td>
                    <td>
            ...
            <div className="it-modal-body">
              <div className="it-form-group">
                ...
                <input
                  ...
                  aria-readonly="true"
                />
                <span className="it-form-hint">Key cannot be changed after creation (Systems DC behaviour)</span>
              </div>
              <div className="it-form-group">
                <label>Name</label>
                <input
