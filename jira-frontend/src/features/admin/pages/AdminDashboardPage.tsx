    ...
    <div className="admin-dashboard">
      <div className="admin-dashboard-hero">
        <div className="admin-dashboard-hero-content">
          ...
          <p>
            Manage users, projects, workflows, and Data Center configuration — aligned with Systems
      ...
      <div className="admin-dashboard-websudo jdc-card" style={{ marginBottom: 20, padding: 16 }}>
        ...
        <p className="jdc-muted" style={{ margin: '0 0 12px', fontSize: 13 }}>
          Systems Data Center shows a yellow banner while you operate with elevated privileges. Enable for 60
