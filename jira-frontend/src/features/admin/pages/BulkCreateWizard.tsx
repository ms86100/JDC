...
function BulkMapFieldsStep() {
  ...
  const handleMappingChange = (index: number, field: 'csvColumn' | 'jiraField', value: string) => {
    ...
    <div className="bulk-step-content">
      ...
      <div className="bulk-form-section">
              ...
              <tr key={index}>
                ...
                <td>
                  <select
                    ...
                    onChange={(e) => handleMappingChange(index, 'jiraField', e.target.value)}
                  >
        ...
        <button
          ...
          onClick={() => setMappings([...mappings, { csvColumn: '', jiraField: '' }])}
        >
          + Add Mapping
        </button>
      </div>
  ...
  return (
    <div className="bulk-step-content">
      ...
      <div className="bulk-form-section">
        ...
        <button
          className="bulk-add-btn"
          onClick={() => setValueMappings([...valueMappings, { csvValue: '', jiraValue: '' }])}
        >
          + Add Mapping
        </button>
      </div>
