    ...
    <div className="dc-page ab-analytics-page">
      ...
      <div className="ab-analytics-toolbar">
        <div className="ab-analytics-toolbar-left">
          <span style={{ fontSize: 13, fontWeight: 600, color: '#5e6c84' }}>Time range</span>
      ...
      <div className="ab-insights-grid">
        <section className="ab-chart-panel">
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
            {[
              { label: 'To Do', pct: 28, color: '#dfe1e6' },
              { label: 'In progress', pct: 35, color: '#0052cc' },
              { label: 'Done', pct: 37, color: '#006644' },
            ].map((row) => (
              <div key={row.label}>
                <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: 13, marginBottom: 4 }}>
                  <span style={{ color: '#42526e', fontWeight: 500 }}>{row.label}</span>
                  <span style={{ color: '#5e6c84' }}>{row.pct}%</span>
                </div>
      ...
      <p style={{ fontSize: 13, color: '#5e6c84' }}>
        ...
        <Link to="/admin/reports" style={{ color: '#0052cc', fontWeight: 500 }}>
          Reports
        </Link>
        .
      </p>
