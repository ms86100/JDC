...
import type { JiraDcValidateResponse } from '../../../api/serviceApi';
import {
  conflictRowId,
...
interface Props {
  conflicts: JiraDcValidateResponse['conflicts'];
...
export default function DcImportConflictPanel({
  ...
  const renderRow = (c: NonNullable<JiraDcValidateResponse['conflicts']>[number], index: number) => {
