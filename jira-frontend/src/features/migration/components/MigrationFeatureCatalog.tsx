...
const CATALOG: CatalogItem[] = [
  ...
  { area: 'Import', feature: 'Issue XML (Jira DC)', uiLocation: 'Import wizard → Issue XML (Jira DC)', wizardStep: 'source', testable: 'UI+API', navigateTo: 'wizard', importType: 'issue-xml' },
  { area: 'Import', feature: 'Systems and Avionics backup', uiLocation: 'Import wizard → Systems and Avionics Backup', wizardStep: 'source', testable: 'UI+API', navigateTo: 'wizard', importType: 'jira-dc' },
  ...
  { area: 'Import', feature: 'DC AC sign-off preview (configure)', uiLocation: 'Jira DC → Configure → Validate now → Enterprise AC table', wizardStep: 'configure', testable: 'UI+API', navigateTo: 'wizard', importType: 'jira-dc' },
  ...
  { area: 'Import', feature: 'DC options (delta, resume, bundle)', uiLocation: 'Wizard → Configure → DC options', wizardStep: 'configure', testable: 'UI', navigateTo: 'wizard', importType: 'jira-dc' },
  { area: 'Import', feature: 'Conflict & unknown custom fields', uiLocation: 'Validate / Configure / Review → conflict & unknown panels', wizardStep: 'validate', testable: 'UI+API', navigateTo: 'wizard', importType: 'jira-dc' },
  { area: 'Import', feature: 'DC relationship graph', uiLocation: 'Validate / Configure → relationship graph panel', wizardStep: 'validate', testable: 'UI', navigateTo: 'wizard', importType: 'jira-dc' },
  { area: 'Import', feature: 'DC review & execute gate', uiLocation: 'Review → DC review panel (warnings ack)', wizardStep: 'review', testable: 'UI', navigateTo: 'wizard', importType: 'jira-dc' },
  { area: 'Import', feature: 'Stub vs live downstream (DC)', uiLocation: 'Configure → DC options', wizardStep: 'configure', testable: 'UI+API', navigateTo: 'wizard', importType: 'jira-dc' },
  ...
  { area: 'Post-import', feature: 'DC staging insights', uiLocation: 'Complete / Job detail', wizardStep: 'complete', testable: 'UI+API', navigateTo: 'wizard', importType: 'jira-dc' },
  { area: 'Post-import', feature: 'Parity / SLA / AC sign-off', uiLocation: 'Complete + Job console (Jira DC)', wizardStep: 'complete', testable: 'UI+API', navigateTo: 'wizard', importType: 'jira-dc' },
  { area: 'Post-import', feature: 'DC rollback / retry / reports', uiLocation: 'Complete → DC operations + Job console', wizardStep: 'complete', testable: 'UI+API', navigateTo: 'wizard', importType: 'jira-dc' },
