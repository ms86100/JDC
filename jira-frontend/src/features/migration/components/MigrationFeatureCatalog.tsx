...
const CATALOG: CatalogItem[] = [
  ...
  { area: 'Import', feature: 'DC AC sign-off preview (configure)', uiLocation: 'Systems DC → Configure → Validate now → Enterprise AC table', wizardStep: 'configure', testable: 'UI+API', navigateTo: 'wizard', importType: 'jira-dc' },
  ...
  { area: 'Post-import', feature: 'Parity / SLA / AC sign-off', uiLocation: 'Complete + Job console (Systems DC)', wizardStep: 'complete', testable: 'UI+API', navigateTo: 'wizard', importType: 'jira-dc' },
