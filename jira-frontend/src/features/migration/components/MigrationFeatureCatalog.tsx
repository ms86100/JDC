...
const CATALOG: CatalogItem[] = [
  { area: 'Import', feature: 'CSV / Excel import', uiLocation: 'Import wizard → Source', wizardStep: 'source', testable: 'UI+API', navigateTo: 'wizard' },
  { area: 'Import', feature: 'Jira DC XML import', uiLocation: 'Import wizard → Systems and Avionics Backup', wizardStep: 'source', testable: 'UI+API', navigateTo: 'wizard' },
  { area: 'Import', feature: 'Workflow XML import', uiLocation: 'Import wizard → Workflow XML', wizardStep: 'source', testable: 'UI+API', navigateTo: 'wizard' },
  { area: 'Import', feature: 'Project-to-project copy', uiLocation: 'Import wizard → Project Copy', wizardStep: 'source', testable: 'UI+API', navigateTo: 'wizard' },
  ...
  { area: 'Import', feature: 'DC options (delta, resume, bundle)', uiLocation: 'Wizard → Configure → DC options', wizardStep: 'configure', testable: 'UI', navigateTo: 'wizard' },
  { area: 'Import', feature: 'Conflict & unknown custom fields', uiLocation: 'Validate / Configure / Review → conflict & unknown panels', wizardStep: 'validate', testable: 'UI+API', navigateTo: 'wizard' },
  { area: 'Import', feature: 'DC relationship graph', uiLocation: 'Validate / Configure → relationship graph panel', wizardStep: 'validate', testable: 'UI', navigateTo: 'wizard' },
  { area: 'Import', feature: 'DC review & execute gate', uiLocation: 'Review → DC review panel (warnings ack)', wizardStep: 'review', testable: 'UI', navigateTo: 'wizard' },
  { area: 'Import', feature: 'Stub vs live downstream (DC)', uiLocation: 'Configure → DC options', wizardStep: 'configure', testable: 'UI+API', navigateTo: 'wizard' },
  ...
  { area: 'Post-import', feature: 'DC staging insights', uiLocation: 'Complete / Job detail', wizardStep: 'complete', testable: 'UI+API', navigateTo: 'wizard' },
  { area: 'Post-import', feature: 'Parity / SLA / AC sign-off', uiLocation: 'Complete + Job console (Jira DC)', wizardStep: 'complete', testable: 'UI+API', navigateTo: 'wizard' },
  { area: 'Post-import', feature: 'DC rollback / retry / reports', uiLocation: 'Complete → DC operations + Job console', wizardStep: 'complete', testable: 'UI+API', navigateTo: 'wizard' },
  ...
  { area: 'Workflow', feature: 'Workflow graph preview', uiLocation: 'Workflow XML → Validate', wizardStep: 'validate', testable: 'UI+API', navigateTo: 'wizard' },
  { area: 'Workflow', feature: 'Simulate transition path', uiLocation: 'Workflow XML panel', testable: 'UI+API', navigateTo: 'wizard' },
