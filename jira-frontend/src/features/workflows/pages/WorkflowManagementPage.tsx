...
export default function WorkflowManagementPage() {
  ...
  const filtered = (Array.isArray(workflows) ? workflows : []).filter((w) =>
    ...
    <div className="wf-page">
      <header className="wf-page-header">
        <div>
          ...
          <p className="wf-muted">
            Create, version, and publish workflows. Map them to issue types via workflow schemes — Systems Data Center style.
          </p>
        </div>
      ...
      {tab === 'guide' && (
        <section className="wf-panel wf-architecture">
          ...
          <p className="wf-muted">
            Use the visual designer to drag statuses, publish drafts, and configure transition conditions, validators, and post-functions per Systems DC.
          </p>
        </section>
      )}
    </div>
