...
const DEFAULT_NODE_COLOR = '#f4f5f7';
const INITIAL_NODE_COLOR = '#e3fcef';
const FINAL_NODE_COLOR = '#deebff';
const ACTIVE_NODE_COLOR = '#0052cc';
const CURRENT_NODE_COLOR = '#00b8d9';
const TRAVERSED_EDGE_COLOR = '#0052cc';
...
const stateTypeStyles = {
  INITIAL: { color: INITIAL_NODE_COLOR, border: '#36b37e', label: 'Start' },
  INTERMEDIATE: { color: DEFAULT_NODE_COLOR, border: '#dfe1e6', label: '' },
