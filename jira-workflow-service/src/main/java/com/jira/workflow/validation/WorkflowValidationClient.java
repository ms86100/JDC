...
/**
 * Client for workflow validation - can be called from jira-issue-service to validate
...
public class WorkflowValidationClient {
    ...
    @Value("${jira.services.workflow-url:http://localhost:8087}")
    private String workflowServiceUrl;

    /**
     * Validates a transition by transition ID using context map from the caller.
     * This is the main entry point for external services like jira-issue-service.
     *
