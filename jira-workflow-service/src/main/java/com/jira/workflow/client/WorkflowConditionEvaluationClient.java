package com.jira.workflow.client;

import com.jira.workflow.config.PatchCapableRestTemplate;
import com.jira.workflow.dto.EvaluateConditionsRequest;
import com.jira.workflow.dto.EvaluateConditionsResponse;
 ...
 * Can be used by jira-issue-service or other services that need to evaluate
...
public class WorkflowConditionEvaluationClient {
     ...
     * Called by external services (like jira-issue-service).
     *
