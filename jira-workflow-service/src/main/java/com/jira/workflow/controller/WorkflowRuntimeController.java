...
import com.jira.workflow.engine.BulkWorkflowTransitionService;
import com.jira.workflow.engine.WorkflowExecutionEngine;
...
@Tag(name = "Workflow Runtime", description = "Jira DC-style transition execution")
