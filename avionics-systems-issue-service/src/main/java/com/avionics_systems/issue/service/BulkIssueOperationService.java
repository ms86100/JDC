...
import com.avionics_systems.issue.dto.bulk.*;
...
import com.avionics_systems.issue.dto.bulk.BulkOperationType;
import com.avionics_systems.issue.security.ProjectPermissionGuard;
...
public class BulkIssueOperationService {
    ...
    @Value("${sprint.service.url:http://avionics-systems-sprint-service:8091}")
