...
public class KafkaConfig {
    ...
    @Value("${spring.kafka.consumer.group-id:avionics-systems-issue-service}")
    ...
    public ConsumerFactory<String, Object> consumerFactory() {
        ...
        configProps.put(JsonDeserializer.TRUSTED_PACKAGES, "com.avionics_systems.issue.events");
