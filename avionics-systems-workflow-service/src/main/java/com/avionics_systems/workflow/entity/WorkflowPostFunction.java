 ...
 * Matches Avionics Systems DC's OFBiz WorkflowAction
 */
@Entity
...
public class WorkflowPostFunction {
    ...
    // Function types - Extended from Avionics Systems DC
    ...
    // Legacy Avionics Systems DC types (backwards compatibility)
    ...
    public static final String TYPE_LOG_WORK = "LOG_WORK";
}