...
public class WorkflowIntegrationClient {
    ...
    @Value("${avionics-systems.services.notification-url:http://avionics-systems-notification-service:8087}")
    private String notificationServiceUrl;

    public String getNotificationServiceUrl() { return notificationServiceUrl; }

    @Value("${avionics-systems.services.comment-url:http://localhost:8086}")
    private String commentServiceUrl;

    @Value("${avionics-systems.services.attachment-url:http://localhost:8090}")
    ...
    @Value("${avionics-systems.services.search-url:http://localhost:8088}")
    private String searchServiceUrl;

    @Value("${avionics-systems.services.version-url:http://avionics-systems-version-service:8096}")
    private String versionServiceUrl;

    @Value("${avionics-systems.services.component-url:http://avionics-systems-component-service:8097}")
    private String componentServiceUrl;

    @Value("${avionics-systems.services.test-url:http://avionics-systems-test-service:8095}")
    private String testServiceUrl;

    @Value("${avionics-systems.services.plan-url:http://avionics-systems-plan-service:8098}")
