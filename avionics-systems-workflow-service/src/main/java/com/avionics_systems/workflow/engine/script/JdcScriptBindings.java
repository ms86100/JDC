...
import com.avionics_systems.workflow.repository.ScriptPersistentVarRepository;
...
public class JdcScriptBindings {
    ...
    @Value("${avionics-systems.services.confluence-url:}")
    private String confluenceUrl;

    @Value("${avionics-systems.services.plan-url:http://avionics-systems-plan-service:8092}")
    private String planServiceUrl;

    @Value("${avionics-systems.services.admin-url:http://avionics-systems-admin-service:8093}")
