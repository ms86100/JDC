...
import com.avionics_systems.workflow.dto.WorkflowLayoutResponse;
import com.avionics_systems.workflow.dto.WorkflowDiagramResponse;
import com.avionics_systems.workflow.entity.WorkflowLayout;
...
import com.avionics_systems.workflow.repository.WorkflowLayoutRepository;
import com.avionics_systems.workflow.repository.WorkflowLayoutNodeRepository;
import com.avionics_systems.workflow.repository.WorkflowLayoutEdgeRepository;
import com.avionics_systems.workflow.repository.WorkflowRepository;
...
public class WorkflowLayoutController {
    ...
    public ResponseEntity<WorkflowLayoutResponse> getWorkflowLayout(
        ...
        List<com.avionics_systems.workflow.dto.WorkflowLayoutNodeResponse> nodeResponses = nodes.stream()
                .map(this::mapToNodeResponse)
                .collect(Collectors.toList());

        List<com.avionics_systems.workflow.dto.WorkflowLayoutEdgeResponse> edgeResponses = edges.stream()
    ...
    private com.avionics_systems.workflow.dto.WorkflowLayoutNodeResponse mapToNodeResponse(WorkflowLayoutNode node) {
        return com.avionics_systems.workflow.dto.WorkflowLayoutNodeResponse.builder()
                .id(node.getId())
                .statusId(node.getStatusId())
                .nodeType(node.getNodeType())
    ...
    private com.avionics_systems.workflow.dto.WorkflowLayoutEdgeResponse mapToEdgeResponse(WorkflowLayoutEdge edge) {
        return com.avionics_systems.workflow.dto.WorkflowLayoutEdgeResponse.builder()
                .id(edge.getId())
                .transitionId(edge.getTransitionId())
                .fromNodeId(edge.getFromNodeId())
                .toNodeId(edge.getToNodeId())
