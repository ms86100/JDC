...
CREATE INDEX idx_issue_links_dest ON jira_issue.issue_links(destination_issue_id);
...
CREATE INDEX idx_labels_name ON jira_issue.labels(name);
CREATE UNIQUE INDEX idx_labels_issue_name ON jira_issue.labels(issue_id, LOWER(name));
