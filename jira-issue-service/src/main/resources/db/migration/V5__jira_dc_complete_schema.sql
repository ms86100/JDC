...
INSERT INTO jira_issue.security_levels (id, name, description, sort_order) VALUES
    ('s0000000-0000-0000-0000-000000000001', 'All Users', 'All users can view this issue', 1),
    ('s0000000-0000-0000-0000-000000000002', 'Project Role', 'Users with specific project role', 2)
...
INSERT INTO jira_issue.screens (id, name, description, is_default) VALUES
    ('scr-default', 'Default Issue Screen', 'Default screen for all issue types', TRUE)
ON CONFLICT DO NOTHING;

INSERT INTO jira_issue.screen_tabs (id, screen_id, name, position) VALUES
    ('tab-description', 'scr-default', 'Description', 1),
    ('tab-details', 'scr-default', 'Details', 2),
    ('tab-comments', 'scr-default', 'Comments', 3)
ON CONFLICT DO NOTHING;

-- ============================================
-- CHANGE HISTORY (ENHANCED)
-- ============================================
DROP TABLE IF EXISTS jira_issue.change_groups;
...
INSERT INTO jira_issue.issue_types (id, name, icon, description) VALUES
    ('type-epic', 'Epic', 'epic', 'An epic that contains stories')
ON CONFLICT DO NOTHING;
...
-- ============================================
INSERT INTO jira_issue.issue_types (id, name, icon, description) VALUES
    ('type-subtask', 'Sub-task', 'subtask', 'A sub-task of a parent issue')
ON CONFLICT DO NOTHING;
...
CREATE INDEX IF NOT EXISTS idx_issues_sprint ON jira_issue.issues(sprint_id);
