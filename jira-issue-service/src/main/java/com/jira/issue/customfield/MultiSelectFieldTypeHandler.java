...
public class MultiSelectFieldTypeHandler extends AbstractCustomFieldTypeHandler {

    private final CustomFieldOptionRepository optionRepository;

    @Override
    public String getType() { return "multiselect"; }

    @Override
    public String getDisplayName() { return "Select List (Multiple Choices)"; }
