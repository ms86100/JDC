 ...
 */
class LegacyDcLiveImportSlaTest {
    ...
    void slaProofBuilder_smallBatch_metWhenFast() {
        Map<String, Object> proof = LegacyDcImportSlaProofBuilder.build(50, 30_000, 0, false, "LIVE_IMPORT_JOB");
    ...
    void slaProofBuilder_stubNeverCountsAsMet() {
        Map<String, Object> proof = LegacyDcImportSlaProofBuilder.build(1000, 10_000, 0, true, "LIVE_IMPORT_JOB");
    ...
    void parseProof_1000Issues_underParseSla() throws Exception {
        ...
        var entities = LegacyDcEntitiesXmlParser.parse(file);
        long elapsed = System.currentTimeMillis() - start;

        Map<String, Object> proof = LegacyDcImportSlaProofBuilder.buildParseProof(1000, elapsed);
    ...
    void liveTier_benchmark_1000Issues_parseUnder1kSla() throws Exception {
        ...
        long start = System.currentTimeMillis();
        LegacyDcEntitiesXmlParser.parse(file);
        long elapsed = System.currentTimeMillis() - start;

        Map<String, Object> liveProof = LegacyDcImportSlaProofBuilder.build(1000, elapsed, 0, false, "LIVE_IMPORT_BENCHMARK");
        assertTrue(elapsed < LegacyDcImportSlaPolicy.LIVE_IMPORT_1K_MAX_MS,
