package com.avionics_systems.migration.workflow;
...
class LegacyDcWorkflowXmlParserTest {

    private final LegacyDcWorkflowXmlParser parser = new LegacyDcWorkflowXmlParser();
    private final LegacyDcWorkflowSchemeXmlParser schemeParser = new LegacyDcWorkflowSchemeXmlParser();
    private final WorkflowXmlValidationService validationService =
            new WorkflowXmlValidationService(new WorkflowGraphBuilder(), new com.avionics_systems.migration.workflow.registry.OsWorkflowDescriptorRegistry(new com.fasterxml.jackson.databind.ObjectMapper()));
