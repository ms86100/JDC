...
/**
 * Migration import settings (Legacy DC parity: attachment limits, FILE: import dir).
 */
@RestController
...
public class MigrationImportSettingsController {
    ...
    public ResponseEntity<Map<String, Object>> getSettings() {
        ...
        body.put("storageNote", "Attachments are stored via attachment-service (port 8090), analogous to AVIONICS_SYSTEMS_HOME/data/attachments.");
