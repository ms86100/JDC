...
import com.avionics_systems.migration.dto.FieldDiscoveryResponse;
import com.avionics_systems.migration.dto.FieldDefinitionResponse;
import com.avionics_systems.migration.dto.FieldProvisioningResponse;
import com.avionics_systems.migration.entity.field.FieldDefinition;
import com.avionics_systems.migration.service.ImportWizardSessionService;
import com.avionics_systems.migration.service.ValidationReportService;
import com.avionics_systems.migration.service.field.FieldDiscoveryService;
...
public class ImportWizardController {
    ...
    public ResponseEntity<List<FieldMapping>> getFieldMappings(
        ...
        return ResponseEntity.ok(fieldMappingRepository.findBySourceTypeAndTargetType(sourceType, "AVIONICS_SYSTEMS_PLATFORM"));
    }

    @PostMapping("/sessions/{sessionId}/fields/discover")
    @Operation(summary = "Discover CSV/XML headers against platform fields (Legacy DC field mapping step)")
    ...
    @Operation(summary = "Auto-create custom fields for unmapped CSV columns (Legacy DC External Import behavior)")
