package com.avionics_systems.migration;
...
@EnableAsync
@EnableScheduling
public class AvionicsSystemMigrationServiceApplication {
    public static void main(String[] args) {
        SpringApplication.run(AvionicsSystemMigrationServiceApplication.class, args);
    }
