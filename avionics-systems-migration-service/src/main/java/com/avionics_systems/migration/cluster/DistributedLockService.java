 ...
 *
 * Note: This interface is specific to migration-service and uses migration-local
 * LockHandle/LockInfo types. The cluster-commons module provides a parallel
 * interface (com.avionics_systems.cluster.lock.DistributedLockService) for other services.
 */
