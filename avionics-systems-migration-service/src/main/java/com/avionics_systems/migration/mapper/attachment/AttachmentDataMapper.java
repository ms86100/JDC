package com.avionics_systems.migration.mapper.attachment;

import com.avionics_systems.migration.dto.attachment.FileValidationResult;
import com.avionics_systems.migration.storage.AttachmentUploadRequest;
...
/**
 * Mapper for converting attachment data from various sources (CSV, Legacy DC XML)
...
public class AttachmentDataMapper {
    ...
    /**
     * Map from Legacy DC XML attachment element to AttachmentUploadRequest.
     *
     ...
     */
    public AttachmentUploadRequest mapFromLegacyDcXml(Map<String, Object> xmlAttachment, String issueId) {
