...
public class SearchServiceClient extends BaseServiceClient {
    ...
    public ReindexStatusResponse reindexAll(String entityType) {
        ...
        Map<String, String> body = entityType != null ? Map.of("entityType", entityType) : Map.of();
        ReindexStatusResponse response = executePost(endpoint, body, ReindexStatusResponse.class);
        return response;
    }
