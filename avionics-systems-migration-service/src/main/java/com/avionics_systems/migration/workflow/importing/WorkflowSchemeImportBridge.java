...
import com.avionics_systems.migration.service.clients.WorkflowSchemeServiceClient;
...
public class WorkflowSchemeImportBridge {
    ...
    @Value("${app.workflow.default-scheme-description:DC scheme import}")
    private String defaultSchemeDescription;
    ...
    public Map<String, Object> importScheme(WorkflowSchemeModel scheme, UUID defaultWorkflowId, boolean stubDownstream) {
        ...
        try {
            Map<String, Object> created = schemeServiceClient.createScheme(
                    scheme.getName(),
                    scheme.getMeta().getOrDefault("legacy.description", defaultSchemeDescription),
                    defaultWorkflowId);
