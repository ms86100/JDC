...
import com.avionics_systems.migration.entity.DcStagingEntry;
import com.avionics_systems.migration.parser.LegacyDcXmlParser;
import com.avionics_systems.migration.repository.DcStagingEntryRepository;
...
public class LegacyDcStagingService {

    private final DcStagingEntryRepository stagingRepository;
    private final ObjectMapper objectMapper;

    @Transactional
    public UUID stageParsedEntities(UUID jobId, List<LegacyDcXmlParser.ParsedEntity> entities, String rawXmlSnippet) {
    ...
    public List<LegacyDcXmlParser.ParsedEntity> toParsedEntities(List<DcStagingEntry> staged) {
        List<LegacyDcXmlParser.ParsedEntity> out = new ArrayList<>();
    ...
    private static String extractSourceId(LegacyDcXmlParser.ParsedEntity entity) {
