 ...
 */
public final class LegacyDcImportSlaProofBuilder {

    private LegacyDcImportSlaProofBuilder() {
    }
    ...
    public static Map<String, Object> build(
        ...
        long maxAllowedMs = LegacyDcImportSlaPolicy.maxDurationMsForIssueCount(issueCount);
        ...
        proof.put("slaTier", issueCount >= LegacyDcImportSlaPolicy.TIER_10K_ISSUES ? "10K"
                : issueCount >= LegacyDcImportSlaPolicy.TIER_1K_ISSUES ? "1K" : "SMALL");
        if (stubDownstream) {
    ...
    public static Map<String, Object> buildParseProof(int issueCount, long parseDurationMs) {
        boolean slaMet = issueCount > 0 && parseDurationMs <= LegacyDcImportSlaPolicy.PARSE_10K_MAX_MS;
        Map<String, Object> proof = new LinkedHashMap<>();
        proof.put("proofType", "PARSE_ONLY");
        proof.put("issueCount", issueCount);
        proof.put("durationMs", parseDurationMs);
        proof.put("maxAllowedMs", LegacyDcImportSlaPolicy.PARSE_10K_MAX_MS);
        proof.put("slaMet", slaMet);
