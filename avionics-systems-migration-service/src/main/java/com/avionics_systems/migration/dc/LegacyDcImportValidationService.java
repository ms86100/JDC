...
import com.avionics_systems.migration.entity.DcUnknownCustomField;
...
import com.avionics_systems.migration.repository.DcUnknownCustomFieldRepository;
...
public class LegacyDcImportValidationService {
    ...
    @Transactional
    public LegacyDcValidationReport validate(
            UUID jobId,
            UUID sessionId,
        ...
        return new LegacyDcValidationReport(
                errors.isEmpty(),
                errors,
                warnings,
                riskScore,
    ...
    public record LegacyDcValidationReport(
            boolean valid,
            List<ValidationResult.ValidationError> errors,
            List<ValidationResult.ValidationWarning> warnings,
            int riskScore,
