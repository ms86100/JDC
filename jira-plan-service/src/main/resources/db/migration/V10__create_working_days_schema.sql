...
VALUES
    (uuid_generate_v4(), 'Standard 5-Day Week', TRUE, TRUE, TRUE, TRUE, TRUE, FALSE, FALSE, 8.00, TRUE),
    (uuid_generate_v4(), '4-Day Work Week', TRUE, TRUE, TRUE, TRUE, FALSE, FALSE, FALSE, 8.00, FALSE);
