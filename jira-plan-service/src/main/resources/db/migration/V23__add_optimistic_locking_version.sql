...
ALTER TABLE jira_plan.plans ADD COLUMN IF NOT EXISTS version BIGINT DEFAULT 0;
ALTER TABLE jira_plan.board_configs ADD COLUMN IF NOT EXISTS version BIGINT DEFAULT 0;
ALTER TABLE jira_plan.sprints ADD COLUMN IF NOT EXISTS version BIGINT DEFAULT 0;
ALTER TABLE jira_plan.plan_items ADD COLUMN IF NOT EXISTS version BIGINT DEFAULT 0;
